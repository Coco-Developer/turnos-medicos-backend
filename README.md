...
- Control de acceso mediante JWT y API Key  

El proyecto fue desarrollado como un caso práctico profesionalizante, poniendo énfasis en buenas prácticas de backend, inyección de dependencias, manejo de errores y seguridad de datos. Permite evidenciar habilidades de diseño de software escalable y trabajo en equipo en un entorno profesional.
